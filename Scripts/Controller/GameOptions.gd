...
func _on_guardar_pressed():
	var overlay_scene = preload("res://Scenes/UI/GuardarPartida.tscn")
...
func _on_reiniciar_pressed():
	var overlay_scene = preload("res://Scenes/UI/ConfirmOptions.tscn")
	var instance = overlay_scene.instantiate()
	add_child(instance)
	instance.position = Vector2(0,0)
...
func _on_cambiar_configuracion_pressed():
	var overlay_scene = preload("res://Scenes/UI/CambiarConfiguracion.tscn")
	var instance = overlay_scene.instantiate()
	add_child(instance)
	instance.position = Vector2(0,0)
